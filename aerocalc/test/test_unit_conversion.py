...
class Test_vol_conv(unittest.TestCase):
    ...
    def test_05(self):
        ...
        Truth = (5280 / (1852.0 / 0.3048)) ** 3
        self.assertTrue(RE(Value, Truth) <= 1e-5)

    def test_06(self):
        Value = U.vol_conv(1, to_units="USG", from_units="nm**3")
        Truth = 7.4805195 * (1852.0 / 0.3048) ** 3
        self.assertTrue(RE(Value, Truth) <= 1e-5)
...
class Test_avgas_conv(unittest.TestCase):
    ...
    def test_02(self):
        ...
        Value = U.avgas_conv(200.0, from_units="lb", to_units="USG", temp=-40)
        Truth = 200.0 / 6.41
        self.assertTrue(RE(Value, Truth) <= 5e-4)
    ...
    def test_03(self):
        ...
        Value = U.avgas_conv(200.0, from_units="lb", to_units="ImpGal", grade="100LL")
        Truth = (((200.0 / 2.204622622) / 715) * 1000) / 4.54609
        self.assertTrue(RE(Value, Truth) <= 5e-4)
    ...
    def test_04(self):
        ...
        Value = U.avgas_conv(200.0, from_units="kg", to_units="l", grade="100", temp=30)
        Truth = (200.0 / 695) * 1000
    ...
    def test_05(self):
        ...
        Value = U.avgas_conv(200.0, from_units="l", to_units="kg", grade="80", temp=-40)
        Truth = (200.0 / 1000) * 690
